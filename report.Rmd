...
on `r time_of_data`. Option pricing data can be seen at the end of this pdf.
The code written for generating this document can be seen [on Github](https://github.com/refik/options-mfin820).
...
Options used for this analysis have a maturity of 30 days. Raw data for this plot can be observed at the end of this report.  
